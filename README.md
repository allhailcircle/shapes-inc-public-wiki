...
<figure><picture><source srcset=".gitbook/assets/image (1).png" media="(prefers-color-scheme: dark)"><img src=".gitbook/assets/image (1).png" alt=""></picture><figcaption></figcaption></figure>
